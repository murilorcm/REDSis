...
CREATE TABLE disciplinas(codigo int(3) AUTO_INCREMENT, nome varchar(40), sigla varchar(10), professor varchar(40), semestre varchar(20), ano int(4), codigoRed int(3), PRIMARY KEY(codigo));
